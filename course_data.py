...
""",
        ...
        # tuple: (infinitief, english, stam, aux, perfectum_vd, imperf_sg, imperf_pl)
        # aux 'hebben/zijn' means both are accepted in the drill
        "verb_drill_data": [
            # ── Core / most frequent ──────────────────────────────────────────
            ("zijn",       "to be",                  "ben",
             "zijn",        "geweest",     "was",        "waren"),
            ("hebben",     "to have",                "heb",
             "hebben",      "gehad",       "had",        "hadden"),
            ("worden",     "to become",              "word",
             "zijn",        "geworden",    "werd",       "werden"),
            ("gaan",       "to go",                  "ga",
             "zijn",        "gegaan",      "ging",       "gingen"),
            ("komen",      "to come",                "kom",
             "zijn",        "gekomen",     "kwam",       "kwamen"),
            ("doen",       "to do",                  "doe",
             "hebben",      "gedaan",      "deed",       "deden"),
            # ── Modals ───────────────────────────────────────────────────────
            ("kunnen",     "can / be able to",       "kan",
             "hebben",      "gekund",      "kon",        "konden"),
            ("willen",     "to want",                "wil",
             "hebben",      "gewild",      "wou/wilde",  "wilden"),
            ("moeten",     "must / have to",         "moet",
             "hebben",      "gemoeten",    "moest",      "moesten"),
            ("mogen",      "may / be allowed",       "mag",
             "hebben",      "gemogen",     "mocht",      "mochten"),
            ...
            # ── From course vocabulary (regular/zwakke verbs) ─────────────────
            ...
            # ── From course vocabulary (irregular/sterke verbs) ───────────────
            ...
            # ── From course vocabulary (separable verbs) ──────────────────────
            ("opgroeien",  "to grow up",             "groei",
             "zijn",        "opgegroeid",  "groeide op", "groeiden op"),
            ("terugbellen", "to call back",          "bel",
             "hebben",      "teruggebeld", "belde terug", "belden terug"),
            ("thuiswerken", "to work from home",     "werk",
             "hebben",      "thuisgewerkt", "werkte thuis", "werkten thuis"),
            ("uitleggen",  "to explain",             "leg",
             "hebben",      "uitgelegd",   "legde uit",  "legden uit"),
            ("uitnodigen", "to invite",              "nodig",
             "hebben",      "uitgenodigd", "nodigde uit", "nodigden uit"),
            ("uitslapen",  "to sleep in",            "slaap",
             "hebben",      "uitgeslapen", "sliep uit",  "sliepen uit"),
            ("volhouden",  "to persevere / keep up", "houd",
             "hebben",      "volgehouden", "hield vol",  "hielden vol"),
