...
""",
        ...
        "verb_drill_data": [
            ("zijn",      "to be",              "ben",    "zijn",    "geweest",    "was",       "waren"),
            ("hebben",    "to have",             "heb",    "hebben",  "gehad",      "had",       "hadden"),
            ("gaan",      "to go",               "ga",     "zijn",    "gegaan",     "ging",      "gingen"),
            ("komen",     "to come",             "kom",    "zijn",    "gekomen",    "kwam",      "kwamen"),
            ("doen",      "to do",               "doe",    "hebben",  "gedaan",     "deed",      "deden"),
            ("worden",    "to become",           "word",   "zijn",    "geworden",   "werd",      "werden"),
            ("kunnen",    "can / be able to",    "kan",    "hebben",  "gekund",     "kon",       "konden"),
            ("willen",    "to want",             "wil",    "hebben",  "gewild",     "wou/wilde", "wilden"),
            ("moeten",    "must / have to",      "moet",   "hebben",  "gemoeten",   "moest",     "moesten"),
            ("mogen",     "may / be allowed",    "mag",    "hebben",  "gemogen",    "mocht",     "mochten"),
            ...
            ("rijden",    "to drive / ride",     "rijd",   "heb/ben", "gereden",    "reed",      "reden"),
            ("lopen",     "to walk",             "loop",   "heb/ben", "gelopen",    "liep",      "liepen"),
            ...
            ("vergeten",  "to forget",           "vergeet","heb/ben", "vergeten",   "vergat",    "vergaten"),
            ...
            ("zwemmen",   "to swim",             "zwem",   "heb/ben", "gezwommen",  "zwom",      "zwommen"),
            ("slapen",    "to sleep",            "slaap",  "hebben",  "geslapen",   "sliep",     "sliepen"),
            ("vliegen",   "to fly",              "vlieg",  "heb/ben", "gevlogen",   "vloog",     "vlogen"),
