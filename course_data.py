...
""",
        ...
        "exercises": [
            ...
            {"type": "fill", "q": "Zij heeft het hele weekend op UGent ___. (werken → past participle)", "a": "gewerkt",
            ...
            {"type": "translate", "q": "We have never cycled in Belgium.", "a": "Wij hebben nog nooit in België gefietst.",
             "tip": "fietsen → gefietst (ge-…-t, s is in kofschip). Fietsen = not movement A→B → hebben. Wij → hebben."},
            {"type": "reorder", "q": "nooit / nog / hebben / wij / gegeten / wafels",
             "a": "Wij hebben nog nooit wafels gegeten.",
...
""",
        ...
        "exercises": [
            ...
            {"type": "fill", "q": "In een e-mail aan een vriend: Hij gelooft dat je gelijk ___.", "a": "hebt",
            ...
            {"type": "fill", "q": "In een gesprek met je buurvrouw: Wij denken dat het weer morgen beter ___.", "a": "is",
            ...
            {"type": "translate", "q": "She thinks that Ghent is a beautiful city.", "a": "Zij denkt dat Gent een mooie stad is.",
             "tip": "Use 'Zij denkt dat…'. Verb 'is' to the end. beautiful city = mooie stad (de stad → +e)."},
    ...
    # =====================================================================
    {
        ...
        "vocabulary": [
            ...
            {"nl": "meestal", "en": "usually",
                "ex": "Meestal fietst hij naar UGent."},
...
""",
        ...
        "exercises": [
            ...
            {"type": "fill", "q": "Jullie routine in Gent: 'Eerst ___ wij ontbijt, daarna gaan wij naar UGent.' (eten)", "a": "eten",
             "tip": "Eerst + verb + wij. Eten → wij eten (plural!)."},
            ...
            {"type": "fill", "q": "Zijn dagelijks leven: 'Meestal ___ hij langs de Coupure naar UGent.' (fietsen)", "a": "fietst",
             "tip": "Meestal + verb + hij. Fietsen → hij fietst (-t for hij/zij). De Coupure is a canal in Ghent."},
            {"type": "fill", "q": "Jullie avondprogramma: ''s Avonds ___ jullie een serie op Netflix.' (kijken)", "a": "kijken",
             "tip": "'s Avonds (time) starts the sentence → inversie: kijken jullie. Plural form!"},
            ...
            {"type": "translate", "q": "In the morning she cycles to the university.", "a": "'s Ochtends fietst zij naar de universiteit.",
             "tip": "In the morning = 's Ochtends. Cycle = fietsen → zij fietst. Time first → inversie!"},
    ...
    # =====================================================================
    {
        ...
        "vocabulary": [
            ...
            # --- Irregular imperfectum verbs ---
            {"nl": "gaan → ging", "en": "to go → went",
                "ex": "Hij ging naar school."},
            {"nl": "komen → kwam", "en": "to come → came",
                "ex": "Hij kwam te laat."},
            {"nl": "zien → zag", "en": "to see → saw",
                "ex": "Je zag een mooie film."},
            {"nl": "doen → deed", "en": "to do → did",
                "ex": "Zij deed haar best."},
            {"nl": "eten → at", "en": "to eat → ate",
                "ex": "Zij at altijd rijst."},
            {"nl": "drinken → dronk", "en": "to drink → drank",
                "ex": "We dronken koffie."},
            {"nl": "lezen → las", "en": "to read → read",
                "ex": "Zij las een boek."},
            {"nl": "schrijven → schreef", "en": "to write → wrote",
                "ex": "Hij schreef een brief."},
            {"nl": "nemen → nam", "en": "to take → took",
                "ex": "Zij nam de trein."},
            {"nl": "slapen → sliep", "en": "to sleep → slept",
                "ex": "Het kind sliep goed."},
            {"nl": "lopen → liep", "en": "to walk → walked",
                "ex": "We liepen door het park."},
            {"nl": "rijden → reed", "en": "to drive → drove",
                "ex": "Hij reed naar Brussel."},
            {"nl": "staan → stond", "en": "to stand → stood",
                "ex": "Hij stond bij de halte."},
            {"nl": "zitten → zat", "en": "to sit → sat",
                "ex": "Zij zat op de bank."},
            {"nl": "liggen → lag", "en": "to lie → lay",
                "ex": "De kat lag op het bed."},
            {"nl": "denken → dacht", "en": "to think → thought",
                "ex": "Zij dacht dat het vrijdag was."},
            {"nl": "brengen → bracht", "en": "to bring → brought",
                "ex": "Zij bracht een cadeau mee."},
            {"nl": "kopen → kocht", "en": "to buy → bought",
                "ex": "Hij kocht een nieuwe fiets."},
            {"nl": "vinden → vond", "en": "to find → found",
                "ex": "Zij vond het leuk."},
            {"nl": "houden → hield", "en": "to hold/keep → held",
                "ex": "Zij hield van muziek."},
        ],
...
""",
        ...
        "exercises": [
            ...
            # --- Irregular imperfectum drills ---
            {"type": "fill", "q": "Vroeger ___ ik elke dag naar de universiteit. (gaan, imperfectum)", "a": "ging",
             "tip": "gaan is irregular: ging (ik/hij), gingen (wij)."},
            {"type": "fill", "q": "Mijn collega ___ altijd te laat. (komen, imperfectum)", "a": "kwam",
             "tip": "komen is irregular: kwam (singular), kwamen (plural)."},
            {"type": "fill", "q": "We ___ elke avond samen. (eten, imperfectum, plural)", "a": "aten",
             "tip": "eten is irregular: at (ik/hij), aten (wij)."},
            {"type": "fill", "q": "Zij ___ elke ochtend een boek in de trein. (lezen, imperfectum)", "a": "las",
             "tip": "lezen is irregular: las (ik/hij/zij), lazen (wij/jullie/zij-plural)."},
            {"type": "fill", "q": "Als kind ___ hij altijd lange brieven. (schrijven, imperfectum)", "a": "schreef",
             "tip": "schrijven is irregular: schreef (singular), schreven (plural)."},
            {"type": "fill", "q": "Wij ___ altijd de trein naar Brussel. (nemen, imperfectum, plural)", "a": "namen",
             "tip": "nemen is irregular: nam (ik/hij/zij), namen (wij/jullie/zij-plural)."},
            {"type": "fill", "q": "Ze ___ een mooie film op televisie. (zien, imperfectum)", "a": "zag",
             "tip": "zien is irregular: zag (singular), zagen (plural)."},
            {"type": "fill", "q": "Hij ___ dat het een goed idee was. (denken, imperfectum)", "a": "dacht",
             "tip": "denken is irregular: dacht (ik/hij/zij), dachten (wij/jullie/zij-plural)."},
            {"type": "fill", "q": "Mijn vader ___ elke dag met de auto naar zijn werk. (rijden, imperfectum)", "a": "reed",
             "tip": "rijden is irregular: reed (singular), reden (plural)."},
            {"type": "fill", "q": "We ___ vroeger elk weekend een taart. (kopen, imperfectum, plural)", "a": "kochten",
             "tip": "kopen is irregular: kocht (ik/hij), kochten (wij)."},
            {"type": "choice", "q": "Vroeger ___ ik heel goed. (slapen, imperfectum)", "options": ["slaapte", "sliep", "slaapde"], "a": "sliep",
             "tip": "slapen is irregular: sliep (singular), sliepen (plural)."},
            {"type": "choice", "q": "De kinderen ___ urenlang in de tuin. (lopen, imperfectum, plural)", "options": ["loopten", "liepen", "lopten"], "a": "liepen",
             "tip": "lopen is irregular: liep (singular), liepen (plural)."},
            {"type": "choice", "q": "Mijn moeder ___ altijd een cadeau mee. (brengen, imperfectum)", "options": ["brengde", "bracht", "brengte"], "a": "bracht",
             "tip": "brengen is irregular: bracht (singular), brachten (plural)."},
            {"type": "translate", "q": "She always took the train and read a book.", "a": "Zij nam altijd de trein en las een boek.",
             "tip": "nemen → nam (irregular). lezen → las (irregular)."},
            {"type": "translate", "q": "She thought it was fun and bought a gift.", "a": "Zij dacht dat het leuk was en kocht een cadeau.",
             "tip": "denken → dacht. kopen → kocht. Both irregular!"},
        ],
...
""",
        ...
        "exercises": [
            # --- fill (7) ---
            {"type": "fill", "q": "Bij de inschrijving aan UGent: Wij gaan naar de universiteit ___ Nederlands te studeren.", "a": "om",
            ...
            {"type": "fill", "q": "In het weekend: Hij gaat naar de Korenmarkt om met vrienden iets te ___. (drink = drinken)", "a": "drinken",
            ...
            # --- translate (1) ---
            {"type": "translate", "q": "She finds it difficult to get up early.", "a": "Zij vindt het moeilijk om vroeg op te staan.",
             "tip": "Pattern: Zij vindt het [adj] om … te … Separable: op·staan → op te staan."},
            # --- reorder (1) ---
...
""",
        ...
        "exercises": [
            ...
            {"type": "fill", "q": "Op de sportclub: Zij sport elke dag ___ zij gezond wil blijven.", "a": "omdat",
            ...
            {"type": "fill", "q": "Na de les: Wij hebben honger. ___ maken wij een boterham.", "a": "Daarom",
             "tip": "Nieuwe zin + inversie (maken wij) → Daarom."},
            ...
            {"type": "translate", "q": "We eat vegetables because they are healthy. (use omdat)",
             "a": "Wij eten groente omdat ze gezond zijn.",
             "tip": "omdat + subject (ze) + … + werkwoord op einde (zijn). Wij → eten."},
...
""",
    ...
    # ──────────────────────────────────────────────
    {
        ...
        "vocabulary": [
            ...
            # --- Irregular perfectum verbs (must memorise!) ---
            ("doen → gedaan", "to do → done", "Ik heb mijn best gedaan."),
            ("zien → gezien", "to see → seen", "Ik heb een film gezien."),
            ("nemen → genomen", "to take → taken", "Hij heeft de trein genomen."),
            ("kopen → gekocht", "to buy → bought", "Ik heb een fiets gekocht."),
            ("brengen → gebracht", "to bring → brought",
             "Zij heeft bloemen gebracht."),
            ("denken → gedacht", "to think → thought", "Ik heb eraan gedacht."),
            ("slapen → geslapen", "to sleep → slept", "Ik heb goed geslapen."),
            ("lopen → gelopen", "to walk → walked", "We hebben veel gelopen."),
            ("rijden → gereden", "to drive → driven",
             "Hij heeft naar Gent gereden."),
            ("houden → gehouden", "to hold → held", "Zij heeft van hem gehouden."),
            ("vinden → gevonden", "to find → found", "Ik heb het gevonden!"),
            ("staan → gestaan", "to stand → stood", "Ik heb lang gestaan."),
            ("zitten → gezeten", "to sit → sat", "We hebben uren gezeten."),
            ("liggen → gelegen", "to lie → lain",
             "Het boek heeft op tafel gelegen."),
            ("spreken → gesproken", "to speak → spoken",
             "We hebben Nederlands gesproken."),
            ("vragen → gevraagd", "to ask → asked", "Ik heb het gevraagd."),
            ("weten → geweten", "to know → known", "Ik heb het altijd geweten."),
...
""",
        ...
        "exercises": [
            {"type": "fill", "q": "Na het werk: Wij ___ gisteren in het Citadelpark gewandeld. (hebben/zijn)", "a": "hebben",
             "tip": "Wandelen = activiteit (niet A→B) → hebben. Wij hebben."},
            {"type": "fill", "q": "Een dagtrip: Zij ___ naar Brussel gegaan. (hebben/zijn)", "a": "is",
             "tip": "Gaan = beweging A→B → zijn. zij → is."},
            {"type": "fill", "q": "In de trein: Zij heeft een boek ___. (lezen → voltooid deelwoord)", "a": "gelezen",
            ...
            {"type": "translate", "q": "She has already eaten. (use perfectum)",
             "a": "Zij heeft al gegeten.",
             "tip": "eten → gegeten (onregelmatig). hebben (activiteit). Zij → heeft. al = already."},
            ...
            # --- Irregular perfectum drills ---
            {"type": "fill", "q": "Hij heeft een nieuwe fiets ___. (kopen → voltooid deelwoord)", "a": "gekocht",
             "tip": "kopen → gekocht (irregular, not 'gekoopt')."},
            {"type": "fill", "q": "Hij heeft de hele nacht goed ___. (slapen → voltooid deelwoord)", "a": "geslapen",
             "tip": "slapen → geslapen (irregular strong verb)."},
            {"type": "fill", "q": "We hebben Nederlands ___. (spreken → voltooid deelwoord)", "a": "gesproken",
             "tip": "spreken → gesproken (irregular)."},
            {"type": "fill", "q": "Ik heb een cadeau ___. (geven → voltooid deelwoord)", "a": "gegeven",
             "tip": "geven → gegeven (irregular strong verb)."},
            {"type": "fill", "q": "Zij heeft bloemen ___. (brengen → voltooid deelwoord)", "a": "gebracht",
             "tip": "brengen → gebracht (irregular, not 'gebrengd')."},
            {"type": "fill", "q": "Wij hebben het antwoord ___. (vinden → voltooid deelwoord)", "a": "gevonden",
             "tip": "vinden → gevonden (irregular)."},
            {"type": "fill", "q": "Heb je de film ___? (zien → voltooid deelwoord)", "a": "gezien",
             "tip": "zien → gezien (irregular, not 'gezied')."},
            {"type": "fill", "q": "We hebben de trein ___. (nemen → voltooid deelwoord)", "a": "genomen",
             "tip": "nemen → genomen (irregular)."},
            {"type": "fill", "q": "Zij heeft eraan ___. (denken → voltooid deelwoord)", "a": "gedacht",
             "tip": "denken → gedacht (irregular, not 'gedenkt')."},
            {"type": "fill", "q": "Hij heeft zijn best ___. (doen → voltooid deelwoord)", "a": "gedaan",
             "tip": "doen → gedaan (irregular)."},
            {"type": "choice", "q": "We ___ gisteren veel gelopen. (hebben/zijn)", "options": ["zijn", "hebben"], "a": "hebben",
             "tip": "lopen without clear A→B destination → hebben."},
            {"type": "choice", "q": "Zij ___ naar Brussel gereden. (hebben/zijn)", "options": ["is", "heeft"], "a": "is",
             "tip": "rijden with destination (A→B) → zijn."},
            {"type": "translate", "q": "He slept well and then took the train to Ghent.",
             "a": "Hij heeft goed geslapen en dan de trein naar Gent genomen.",
             "tip": "slapen → geslapen (hebben). nemen → genomen (hebben). Hij → heeft."},
            {"type": "translate", "q": "She gave me a book and I found it very interesting.",
             "a": "Zij heeft me een boek gegeven en ik heb het heel interessant gevonden.",
             "tip": "geven → gegeven. vinden → gevonden. Both hebben."},
        ],
...
""",
        ...
        "exercises": [
            ...
            {"type": "fill", "q": "Over haar jeugd: Vroeger ___ (wonen, imperfectum) zij in India.", "a": "woonde",
             "tip": "Gewoonte in het verleden → imperfectum. wonen → woonde (regelmatig: woon + de)."},
            {"type": "fill", "q": "Gisteren op het werk: Gisteren ___ (hebben, imperfectum) wij geen tijd.", "a": "hadden",
             "tip": "hebben → hadden (imperfectum, plural). Gewoon in gesproken Nederlands."},
            ...
            # --- Mix irregular verbs: perfectum vs imperfectum ---
            {"type": "fill", "q": "Vroeger ___ zij altijd rijst. (eten, imperfectum — past habit)", "a": "at",
             "tip": "Past habit → imperfectum. eten → at (irregular, same for ik/hij/zij)."},
            {"type": "fill", "q": "Gisteren ___ ik een boek ___. (kopen, perfectum — conversation)", "a": "heb ... gekocht",
             "tip": "Conversation → perfectum. kopen → gekocht."},
            {"type": "fill", "q": "In het verhaal: De kinderen ___ door het bos. (lopen, imperfectum)", "a": "liepen",
             "tip": "Story → imperfectum. lopen → liep/liepen (irregular)."},
            {"type": "fill", "q": "Gisteren ___ ik goed ___. (slapen, perfectum — conversation)", "a": "heb ... geslapen",
             "tip": "Conversation → perfectum. slapen → geslapen."},
            {"type": "fill", "q": "Als kind ___ hij altijd de bus. (nemen, imperfectum — habit)", "a": "nam",
             "tip": "Past habit → imperfectum. nemen → nam (irregular, same for ik/hij/zij)."},
            {"type": "fill", "q": "Ze ___ me een cadeau ___. (geven, perfectum)", "a": "heeft ... gegeven",
             "tip": "geven → gegeven (irregular). hebben (activiteit)."},
            {"type": "choice", "q": "In een verhaal: 'Hij ___ dat het laat was.' (denken)", "options": ["heeft gedacht", "dacht", "denkte"], "a": "dacht",
             "tip": "Story → imperfectum. denken → dacht (irregular)."},
            {"type": "choice", "q": "In gesprek: 'We ___ gisteren Nederlands ___.' (spreken)", "options": ["spraken", "hebben ... gesproken", "zijn ... gesproken"], "a": "hebben ... gesproken",
             "tip": "Conversation → perfectum. spreken → gesproken."},
            {"type": "choice", "q": "Gewoonte: 'Mijn opa ___ altijd koffie.' (drinken, imperfectum)", "options": ["heeft gedronken", "dronk", "drinkde"], "a": "dronk",
             "tip": "Past habit → imperfectum. drinken → dronk (irregular)."},
            {"type": "translate", "q": "She saw a beautiful church and took many photos. (use perfectum)",
             "a": "Zij heeft een mooie kerk gezien en veel foto's genomen.",
             "tip": "Conversation → perfectum. zien → gezien. nemen → genomen. Zij → heeft."},
            {"type": "translate", "q": "As a child, I always slept at my grandparents' house. (use imperfectum)",
             "a": "Als kind sliep ik altijd bij mijn grootouders.",
             "tip": "Past habit → imperfectum. slapen → sliep (irregular)."},
        ],
...
""",
        ...
        "exercises": [
            ...
            {"type": "choice", "q": "Dagelijkse gewoonte: ___ zij honger heeft, eet zij een boterham.",
             "options": ["Als", "Toen", "Zodra"], "a": "Als",
             "tip": "Herhaling in het heden (elke keer als zij honger heeft) → als."},
            ...
            {"type": "fill", "q": "Plannen: ___ hij klaar is, gaat hij naar huis.", "a": "Als",
             "tip": "Toekomst → als."},
            ...
            {"type": "fill", "q": "Aan een collega: ___ zij klaar is, belt zij je. (as soon as)", "a": "Zodra",
            ...
            {"type": "translate", "q": "When she is tired, she drinks coffee. (present habit)",
             "a": "Als zij moe is, drinkt zij koffie.",
             "tip": "Heden/gewoonte → als. is (werkwoord einde), drinkt zij (inversie)."},
...
""",
        ...
        "exercises": [
            ...
            {"type": "choice", "q": "Uitleg aan docent: Zij gaat niet ___ zij ziek is. (werkwoord op einde)",
             "options": ["omdat", "want", "daarom"], "a": "omdat",
             "tip": "Werkwoord op einde (ziek IS) → Groep B → omdat."},
            ...
            {"type": "fill", "q": "Motivatie: Wij studeren hard ___ wij willen slagen. (so that)", "a": "zodat",
             "tip": "So that (doel) → zodat. Bijzin: werkwoord (slagen/willen) op einde."},
            ...
            {"type": "translate", "q": "He studies hard so that he passes the exam.",
             "a": "Hij studeert hard zodat hij voor het examen slaagt.",
             "tip": "zodat + bijzin (werkwoord einde: slaagt). voor het examen slagen = pass the exam."},
...
""",
        ...
        "exercises": [
            {"type": "fill", "q": "Na het ontbijt: ___ zij heeft gegeten, gaat zij wandelen.", "a": "Nadat",
             "tip": "Het eten gebeurt EERST, dan wandelen. After = nadat."},
            {"type": "fill", "q": "Inpakken: ___ wij vertrekken, moeten wij nog inpakken.", "a": "Voordat",
            ...
            {"type": "fill", "q": "Avondroutine: Hij poetst zijn tanden voordat hij naar bed ___.", "a": "gaat",
             "tip": "Tegenwoordige tijd in beide zinnen met voordat. Hij gaat naar bed."},
            {"type": "choice",
...
""",
        ...
        "exercises": [
            {"type": "fill", "q": "Aan je docent: Zij leert Nederlands ___ zij in Gent woont. (because — bijzin)", "a": "omdat",
             "tip": "Because + werkwoord-einde = omdat. Want heeft normale woordvolgorde."},
            {"type": "fill", "q": "Aan een vriend: Hij woont in Gent. ___ leert hij Nederlands.", "a": "Daarom",
             "tip": "Therefore = daarom. Daarna inversie: daarom LEERT HIJ."},
            {"type": "fill", "q": "In de les: Wij ___ ons Nederlands verbeteren. (want to)", "a": "willen",
             "tip": "Willen + infinitief. Wij WILLEN verbeteren."},
...
""",
        ...
        "exercises": [
            {"type": "fill", "q": "Over haar jeugd: Vroeger ___ zij in India. (live — imperfectum)", "a": "woonde",
             "tip": "Wonen → woonde (regelmatig: woon + de). Achtergrond → imperfectum."},
            {"type": "fill", "q": "Over zijn verhuis: In 2022 ___ hij naar België verhuisd. (zijn — perfectum)", "a": "is",
             "tip": "Verhuizen gebruikt ZIJN: Hij IS verhuisd. Eenmalige gebeurtenis → perfectum."},
            {"type": "fill", "q": "In een verhaal: Toen hij klein ___, speelde hij buiten. (zijn — imperf.)", "a": "was",
             "tip": "Toen-bijzin: werkwoord op het einde. Zijn → was. Toen hij klein WAS."},
            {"type": "fill", "q": "Aan haar docent: Nadat zij ___ gestudeerd, ging zij werken. (hebben — plusquam.)", "a": "had",
             "tip": "Nadat + plusquamperfectum: had + voltooid deelwoord. Had gestudeerd."},
            {"type": "fill", "q": "Over hun kindertijd: Als kind ___ wij elke dag buiten. (play — imperf., plural)", "a": "speelden",
             "tip": "Spelen → speelden (regelmatig: speel + den, plural). Gewoonte in het verleden → imperfectum."},
            {"type": "choice",
...
""",
        ...
        "exercises": [
            {"type": "fill", "q": "Op het examen: Zij vindt ___ sport belangrijk is.", "a": "dat",
             "tip": "Zij vindt DAT … = She thinks that … Dat introduceert een bijzin."},
            ...
            {"type": "translate", "q": "In his opinion, learning Dutch is important.",
             "a": "Volgens hem is Nederlands leren belangrijk.",
             "tip": "Volgens hem → inversie: IS … belangrijk."},
...
""",
        ...
        "exercises": [
            ...
            {"type": "fill", "q": "In haar dagboek: Gisteren ___ zij naar de markt geweest. (zijn — perfectum)", "a": "is",
             "tip": "Gaan/zijn gebruikt ZIJN in perfectum: zij IS geweest. Gisteren IS ZIJ (inversie)."},
            {"type": "fill", "q": "Over hun jeugd: Vroeger ___ wij elke dag rijst. (eat — imperfectum, plural)", "a": "aten",
             "tip": "Eten → imperfectum: aten (onregelmatig, plural). Vroeger aten wij (inversie)."},
            ...
            {"type": "translate", "q": "She has lived in Ghent for two years because she works at UGent.",
             "a": "Zij woont al twee jaar in Gent omdat zij aan UGent werkt.",
             "tip": "Voor duur: al + tijd. Omdat-bijzin: werkwoord-einde (werkt). Aan UGent = at UGent."},
...
""",
        ...
        # Each tuple: (infinitief, stam, aux, voltooid_deelwoord, imperf_sg, imperf_pl)
        "verb_drill_data": [
            ("zijn",      "ben",    "zijn",    "geweest",     "was",        "waren"),
            ("hebben",    "heb",    "hebben",  "gehad",       "had",        "hadden"),
            ("gaan",      "ga",     "zijn",    "gegaan",      "ging",       "gingen"),
            ("komen",     "kom",    "zijn",    "gekomen",     "kwam",       "kwamen"),
            ("doen",      "doe",    "hebben",  "gedaan",      "deed",       "deden"),
            ("worden",    "word",   "zijn",    "geworden",    "werd",       "werden"),
            ("kunnen",    "kan",    "hebben",  "gekund",      "kon",        "konden"),
            ("willen",    "wil",    "hebben",  "gewild",      "wou/wilde",  "wilden"),
            ("moeten",    "moet",   "hebben",  "gemoeten",    "moest",      "moesten"),
            ("mogen",     "mag",    "hebben",  "gemogen",     "mocht",      "mochten"),
            ("zien",      "zie",    "hebben",  "gezien",      "zag",        "zagen"),
            ("zeggen",    "zeg",    "hebben",  "gezegd",      "zei",        "zeiden"),
            ("spreken",   "spreek", "hebben",  "gesproken",   "sprak",      "spraken"),
            ("schrijven", "schrijf","hebben",  "geschreven",  "schreef",    "schreven"),
            ("lezen",     "lees",   "hebben",  "gelezen",     "las",        "lazen"),
            ("denken",    "denk",   "hebben",  "gedacht",     "dacht",      "dachten"),
            ("weten",     "weet",   "hebben",  "geweten",     "wist",       "wisten"),
            ("rijden",    "rijd",   "heb/ben", "gereden",     "reed",       "reden"),
            ("lopen",     "loop",   "heb/ben", "gelopen",     "liep",       "liepen"),
            ("beginnen",  "begin",  "zijn",    "begonnen",    "begon",      "begonnen"),
            ("geven",     "geef",   "hebben",  "gegeven",     "gaf",        "gaven"),
            ("nemen",     "neem",   "hebben",  "genomen",     "nam",        "namen"),
            ("vinden",    "vind",   "hebben",  "gevonden",    "vond",       "vonden"),
            ("helpen",    "help",   "hebben",  "geholpen",    "hielp",      "hielpen"),
            ("krijgen",   "krijg",  "hebben",  "gekregen",    "kreeg",      "kregen"),
            ("staan",     "sta",    "hebben",  "gestaan",     "stond",      "stonden"),
            ("liggen",    "lig",    "hebben",  "gelegen",     "lag",        "lagen"),
            ("zitten",    "zit",    "hebben",  "gezeten",     "zat",        "zaten"),
            ("blijven",   "blijf",  "zijn",    "gebleven",    "bleef",      "bleven"),
            ("vallen",    "val",    "zijn",    "gevallen",    "viel",       "vielen"),
            ("vergeten",  "vergeet","heb/ben", "vergeten",    "vergat",     "vergaten"),
            ("drinken",   "drink",  "hebben",  "gedronken",   "dronk",      "dronken"),
            ("eten",      "eet",    "hebben",  "gegeten",     "at",         "aten"),
            ("kopen",     "koop",   "hebben",  "gekocht",     "kocht",      "kochten"),
            ("vragen",    "vraag",  "hebben",  "gevraagd",    "vroeg",      "vroegen"),
            ("zingen",    "zing",   "hebben",  "gezongen",    "zong",       "zongen"),
            ("zwemmen",   "zwem",   "heb/ben", "gezwommen",   "zwom",       "zwommen"),
            ("slapen",    "slaap",  "hebben",  "geslapen",    "sliep",      "sliepen"),
            ("vliegen",   "vlieg",  "heb/ben", "gevlogen",    "vloog",      "vlogen"),
            ("kijken",    "kijk",   "hebben",  "gekeken",     "keek",       "keken"),
        ],
    },
]
...
# Content-based review Q&A — each session tests its OWN topic's grammar & vocab
_REVIEW_QA = {
    2: [  # S2: Social Media & Giving Opinions — Ik denk dat… bijzin
        {"q": "How do you say 'I think that Dutch is useful'?",
         "a": "Ik denk <b>dat</b> Nederlands nuttig <b>is</b>. (verb to end in dat-bijzin)"},
        {"q": "What happens to the verb after 'dat'?",
         "a": "The verb goes to the <b>end</b>: Ik vind dat het mooi <b>is</b>."},
        {"q": "How do you say 'I (dis)agree'?",
         "a": "Ik ben het <b>(niet) eens</b>. / Ik ga <b>(niet) akkoord</b>."},
        {"q": "Rewrite with 'Ik vind dat': 'Het is gevaarlijk.'",
         "a": "Ik vind <b>dat</b> het gevaarlijk <b>is</b>."},
    ],
    3: [  # S3: Sequencing & Inversie (V2 Rule)
        {"q": "What is the V2 rule (inversie)?",
         "a": "The verb is always in <b>position 2</b>. If something else starts, verb comes before subject."},
        {"q": "Complete with inversie: 'Eerst ___ ik ontbijt.' (eten)",
         "a": "Eerst <b>eet ik</b> ontbijt. (verb before subject)"},
        {"q": "What does ''s ochtends' mean?",
         "a": "<b>In the morning</b>. Also: 's middags, 's avonds."},
        {"q": "Reorder: 'Dan / ik / ga / naar UGent.'",
         "a": "Dan <b>ga ik</b> naar UGent. (inversie after 'Dan')"},
    ],
    4: [  # S4: Life Events & Imperfectum Introduction
        {"q": "How do you form the imperfectum for regular verbs?",
         "a": "Stem + <b>-te(n)</b> if last letter is in 't kofschip, otherwise <b>-de(n)</b>."},
        {"q": "werken → imperfectum (ik)?",
         "a": "<b>werkte</b> (k is in 't kofschip → -te)"},
        {"q": "What does 'er was eens…' mean?",
         "a": "<b>Once upon a time…</b> (start of a fairy tale)"},
        {"q": "What is the difference between 'hoogtepunt' and 'dieptepunt'?",
         "a": "<b>Hoogtepunt</b> = highlight. <b>Dieptepunt</b> = low point."},
    ],
    5: [  # S5: Om…te… Construction
        {"q": "How do you say 'in order to learn Dutch'?",
         "a": "<b>om Nederlands te leren</b>"},
        {"q": "Where does 'te' go with a separable verb? (e.g. opbellen)",
         "a": "Between prefix and verb: <b>om op te bellen</b>"},
        {"q": "Complete: Ik fiets elke dag ___ gezond ___ blijven.",
         "a": "<b>om … te</b> — Ik fiets elke dag om gezond te blijven."},
        {"q": "What does 'het doel' mean?",
         "a": "<b>The goal / the purpose.</b>"},
    ],
    6: [  # S6: Omdat vs Want vs Daarom
        {"q": "What happens to the verb after 'omdat'?",
         "a": "Verb goes to the <b>end</b> (bijzin): omdat ik in Gent <b>woon</b>."},
        {"q": "'Want' or 'omdat'? The word order stays normal (SVO).",
        ...
        {"q": "What does 'voeding' mean?",
         "a": "<b>Nutrition / diet.</b>"},
    ],
    7: [  # S7: Als (if/when) — Conditions & Advice
        {"q": "What happens to the verb in an 'als'-clause?",
         "a": "Verb goes to the <b>end</b>: Als je moe <b>bent</b>, moet je rusten."},
        {"q": "When 'als' comes first, what happens in the main clause?",
         "a": "<b>Inversie</b>: Als je ziek bent, <b>moet je</b> rusten."},
        {"q": "Translate: 'If you are stressed, you should relax.'",
         "a": "Als je stress <b>hebt</b>, <b>moet</b> je ontspannen."},
        {"q": "What does 'gewoonte' mean?",
         "a": "<b>Habit.</b>"},
    ],
    8: [  # S8: Bij de Dokter — Body parts & Complaints
        ...
        {"q": "Translate: 'I have a cold and a fever.'",
         "a": "Ik ben <b>verkouden</b> en ik heb <b>koorts</b>."},
        {"q": "What does 'niezen' mean?",
         "a": "<b>To sneeze.</b>"},
    ],
    9: [  # S9: Gent beschrijven — Comparatives & Superlatives
        {"q": "How do you form the comparative? (e.g. groot)",
        ...
        {"q": "Irregular: goed → ___ → ___",
         "a": "goed → <b>beter</b> → <b>best</b>."},
        {"q": "What does 'gezellig' mean?",
         "a": "<b>Cozy / pleasant.</b> Gent is een gezellige stad."},
    ],
    10: [  # S10: Reizen & Future tense
        {"q": "How do you express the future with 'gaan'?",
         "a": "<b>gaan + infinitive</b>: Ik <b>ga</b> morgen reizen."},
        {"q": "When do you use 'zullen' instead of 'gaan'?",
         "a": "For promises, predictions, proposals: Ik <b>zal</b> je helpen."},
        {"q": "Translate: 'We are going to book a hotel.'",
         "a": "We <b>gaan</b> een hotel <b>boeken</b>."},
        {"q": "What does 'de vertraging' mean?",
         "a": "<b>The delay.</b> De trein heeft vertraging."},
    ],
    11: [  # S11: Het Perfectum
        {"q": "What are the two parts of the perfectum?",
         "a": "<b>hebben/zijn</b> + <b>voltooid deelwoord</b> (past participle)."},
        {"q": "When do you use 'zijn' instead of 'hebben'?",
         "a": "Movement A→B, change of state, zijn/blijven: Ik <b>ben</b> gegaan."},
        {"q": "werken → voltooid deelwoord?",
         "a": "<b>gewerkt</b> (k is in 't kofschip → ge-...-t)"},
        {"q": "What does 'net' mean in a time context?",
         "a": "<b>Just (now)</b> — Ik heb <b>net</b> gegeten."},
    ],
    12: [  # S12: Perfectum vs Imperfectum
        ...
        {"q": "What does 'plotseling' mean?",
         "a": "<b>Suddenly.</b> Plotseling begon het te regenen."},
        {"q": "Can you mix both tenses in one text?",
         "a": "<b>Yes!</b> Background = imperfectum, events = perfectum."},
    ],
    13: [  # S13: Als vs Toen
        {"q": "When do you use 'als' and when 'toen'?",
         "a": "<b>Als</b> = present/future/repeated. <b>Toen</b> = one-time past event."},
        {"q": "What tense always follows 'toen'?",
         "a": "<b>Imperfectum</b>: Toen ik <b>aankwam</b>, regende het."},
        {"q": "'When it rains, I take the bus.' — als or toen?",
         "a": "<b>Als</b> — Als het regent, neem ik de bus. (repeated/general)"},
        {"q": "What does 'sindsdien' mean?",
         "a": "<b>Since then.</b> Sindsdien woon ik in Gent."},
    ],
    14: [  # S14: Connectors overview
        {"q": "Name the three groups of connectors and their word order.",
         "a": "<b>Nevenschikkend</b> (en/maar/want): normal. <b>Onderschikkend</b> (omdat/als/dat): V-end. <b>Bijwoord</b> (daarom/toch/dus): inversie."},
        {"q": "What does 'hoewel' mean and what word order follows?",
         "a": "<b>Although</b> — bijzin connector (V to end): Hoewel het regent, ga ik fietsen."},
        {"q": "What does 'bovendien' mean?",
         "a": "<b>Moreover / besides.</b> Bovendien spreek ik al Engels."},
        {"q": "What does 'tenzij' mean?",
         "a": "<b>Unless.</b> Ik ga, tenzij het regent."},
    ],
    15: [  # S15: ER (part 1)
        ...
        {"q": "Why can't you say 'Ik hou van het'?",
         "a": "Use <b>ervan</b> instead: Ik hou <b>ervan</b>. ('het' + prep → er+prep)"},
        {"q": "Rewrite: 'Ik denk over het probleem.' with er.",
         "a": "Ik denk <b>erover</b>."},
    ],
    16: [  # S16: ER (part 2) — Quantity, Place, Passive
        {"q": "What does 'er' mean in 'Ik heb er drie'?",
         "a": "<b>Quantity</b> — er replaces the noun: drie boeken → ik heb er drie."},
        {"q": "'Er wordt veel gefietst.' — what kind of 'er'?",
         "a": "<b>Passive er</b> — used with passive constructions (er + worden)."},
        {"q": "How many uses of 'er' are there in total?",
         "a": "<b>Five</b>: er+zijn, er+preposition, quantity, place, passive."},
        {"q": "What does 'de bibliotheek' mean?",
         "a": "<b>The library.</b> Er zijn veel boeken in de bibliotheek."},
    ],
    17: [  # S17: Voordat & Nadat
        ...
        {"q": "What does 'de afspraak' mean?",
         "a": "<b>The appointment.</b> Ik heb een afspraak bij de dokter."},
    ],
    18: [  # S18: Pronouns
        {"q": "What are the object forms of 'ik'?",
         "a": "<b>me</b> (unstressed) / <b>mij</b> (stressed)."},
        {"q": "'Ik geef ___ het boek.' (him) — which pronoun?",
         "a": "<b>hem</b> — Ik geef hem het boek."},
        {"q": "When do you use 'zich' vs 'me/je'?",
         "a": "<b>Zich</b> = hij/zij/u/zij(pl). Me/je = ik/jij: Ik was <b>me</b>. Hij wast <b>zich</b>."},
        {"q": "What does 'uitnodigen' mean?",
         "a": "<b>To invite.</b> Ik wil je uitnodigen voor mijn feestje."},
    ],
    19: [  # S19: Fixed prepositions — Verbs
        {"q": "Which preposition: wachten ___?",
         "a": "wachten <b>op</b> — Ik wacht op de bus."},
        {"q": "Which preposition: dromen ___?",
         "a": "dromen <b>van</b> — Ik droom van vakantie."},
        {"q": "Which preposition: luisteren ___?",
         "a": "luisteren <b>naar</b> — Ik luister naar muziek."},
        {"q": "How do you say 'to be interested in'?",
         "a": "zich interesseren <b>voor</b> — Ik interesseer me voor talen."},
    ],
    20: [  # S20: Fixed prepositions — Adjectives
        ...
        {"q": "What does 'afhankelijk van' mean?",
         "a": "<b>Dependent on.</b> Het is afhankelijk van het weer."},
    ],
    21: [  # S21: Uiterlijk beschrijven
        {"q": "'Ik ___ lang.' — zijn or hebben?",
         "a": "<b>zijn</b>: Ik <b>ben</b> lang. (eigenschap/kenmerk)"},
        {"q": "'Ik ___ bruine ogen.' — zijn or hebben?",
         "a": "<b>hebben</b>: Ik <b>heb</b> bruine ogen. (lichaamsdeel)"},
        {"q": "What is the correct order for hair description?",
         "a": "<b>lengte + kleur + stijl</b>: Ik heb <b>lang bruin krullend</b> haar."},
        {"q": "What does 'mollig' mean?",
         "a": "<b>Chubby / plump.</b> Het kind is een beetje mollig."},
    ],
    22: [  # S22: Waarom Nederlands?
        {"q": "How do you say 'I learn Dutch because I live in Ghent'?",
         "a": "Ik leer Nederlands <b>omdat</b> ik in Gent woon."},
        {"q": "How do you say 'Moreover, I need Dutch for my job'?",
         "a": "<b>Bovendien</b> heb ik Nederlands nodig voor mijn werk."},
        {"q": "What does 'de inburgering' mean?",
         "a": "<b>Civic integration.</b> Inburgering is verplicht in België."},
        {"q": "Translate: 'In my opinion, Dutch is useful.'",
         "a": "<b>Volgens mij</b> is Nederlands nuttig."},
    ],
    23: [  # S23: Vroeger vertellen
        {"q": "Which tense for habits in the past?",
         "a": "<b>Imperfectum</b>: Vroeger <b>woonde</b> ik in India."},
        {"q": "Which tense for one-time past events in conversation?",
        ...
        {"q": "What does 'wennen aan' mean?",
         "a": "<b>To get used to.</b> Ik moet wennen aan het weer."},
    ],
    24: [  # S24: Spreken oefenen
        {"q": "What are the main tasks on the NT2 speaking exam?",
         "a": "<b>1.</b> Jezelf voorstellen. <b>2.</b> Foto beschrijven + mening geven."},
        {"q": "How do you start giving your opinion?",
         "a": "<b>Ik vind dat…</b> / <b>Volgens mij…</b> / <b>Naar mijn mening…</b>"},
        {"q": "What does 'het voordeel / het nadeel' mean?",
         "a": "<b>The advantage / the disadvantage.</b>"},
        {"q": "How do you say 'On the other hand…'?",
         "a": "<b>Aan de andere kant…</b> / <b>Maar toch…</b>"},
    ],
    25: [  # S25: Proefexamen — Full review
        {"q": "How do you introduce yourself for the exam?",
         "a": "Ik heet… Ik kom uit… Ik woon in <b>Gent</b>. Ik werk bij <b>UGent</b>."},
        {"q": "How do you describe a photo?",
         "a": "Op de foto <b>zie ik</b>… De persoon <b>heeft/is</b>… Het lijkt alsof…"},
        {"q": "What does 'slagen' mean?",
