...
""",
        ...
        "verb_drill_data": [
            ...
            ("doen",      "doe",    "hebben",
             "gedaan",      "deed",       "deden"),
            ("worden",    "word",   "zijn",
             "geworden",    "werd",       "werden"),
            ("kunnen",    "kan",    "hebben",
             "gekund",      "kon",        "konden"),
            ("willen",    "wil",    "hebben",
             "gewild",      "wou/wilde",  "wilden"),
            ("moeten",    "moet",   "hebben",
             "gemoeten",    "moest",      "moesten"),
            ("mogen",     "mag",    "hebben",
             "gemogen",     "mocht",      "mochten"),
            ("zien",      "zie",    "hebben",
             "gezien",      "zag",        "zagen"),
            ("zeggen",    "zeg",    "hebben",
             "gezegd",      "zei",        "zeiden"),
            ("spreken",   "spreek", "hebben",
             "gesproken",   "sprak",      "spraken"),
            ("schrijven", "schrijf", "hebben",
             "geschreven",  "schreef",    "schreven"),
            ("lezen",     "lees",   "hebben",
             "gelezen",     "las",        "lazen"),
            ("denken",    "denk",   "hebben",
             "gedacht",     "dacht",      "dachten"),
            ("weten",     "weet",   "hebben",
             "geweten",     "wist",       "wisten"),
            ("rijden",    "rijd",   "heb/ben",
             "gereden",     "reed",       "reden"),
            ("lopen",     "loop",   "heb/ben",
             "gelopen",     "liep",       "liepen"),
            ("beginnen",  "begin",  "zijn",
             "begonnen",    "begon",      "begonnen"),
            ("geven",     "geef",   "hebben",
             "gegeven",     "gaf",        "gaven"),
            ("nemen",     "neem",   "hebben",
             "genomen",     "nam",        "namen"),
            ("vinden",    "vind",   "hebben",
             "gevonden",    "vond",       "vonden"),
            ("helpen",    "help",   "hebben",
             "geholpen",    "hielp",      "hielpen"),
            ("krijgen",   "krijg",  "hebben",
             "gekregen",    "kreeg",      "kregen"),
            ("staan",     "sta",    "hebben",
             "gestaan",     "stond",      "stonden"),
            ("liggen",    "lig",    "hebben",
             "gelegen",     "lag",        "lagen"),
            ("zitten",    "zit",    "hebben",
             "gezeten",     "zat",        "zaten"),
            ("blijven",   "blijf",  "zijn",
             "gebleven",    "bleef",      "bleven"),
            ("vallen",    "val",    "zijn",
             "gevallen",    "viel",       "vielen"),
            ("vergeten",  "vergeet", "heb/ben",
             "vergeten",    "vergat",     "vergaten"),
            ("drinken",   "drink",  "hebben",
             "gedronken",   "dronk",      "dronken"),
            ("eten",      "eet",    "hebben",  "gegeten",     "at",         "aten"),
            ("kopen",     "koop",   "hebben",
             "gekocht",     "kocht",      "kochten"),
            ("vragen",    "vraag",  "hebben",
             "gevraagd",    "vroeg",      "vroegen"),
            ("zingen",    "zing",   "hebben",
             "gezongen",    "zong",       "zongen"),
            ("zwemmen",   "zwem",   "heb/ben",
             "gezwommen",   "zwom",       "zwommen"),
            ("slapen",    "slaap",  "hebben",
             "geslapen",    "sliep",      "sliepen"),
            ("vliegen",   "vlieg",  "heb/ben",
             "gevlogen",    "vloog",      "vlogen"),
            ("kijken",    "kijk",   "hebben",
             "gekeken",     "keek",       "keken"),
        ],
    },
